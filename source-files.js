...
sourcesIndex["bamboo_rs_core_ed25519_yasmf"] = {"name":"","dirs":[{"name":"entry","dirs":[{"name":"decode","files":["error.rs","mod.rs"]},{"name":"encode","files":["error.rs","mod.rs"]},{"name":"publish","files":["error.rs","mod.rs"]},{"name":"verify","files":["batch.rs","error.rs","mod.rs"]}],"files":["mod.rs"]},{"name":"signature","files":["error.rs","mod.rs"]},{"name":"util","files":["hex_serde.rs","mod.rs"]}],"files":["lib.rs","yasmf_hash.rs"]};
...
sourcesIndex["snafu"] = {"name":"","files":["backtrace_inert.rs","lib.rs"]};
...
sourcesIndex["yasmf_hash"] = {"name":"","dirs":[{"name":"util","files":["hex_serde.rs","mod.rs"]}],"files":["error.rs","lib.rs"]};
