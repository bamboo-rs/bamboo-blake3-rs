...
use bamboo_blake3_rs_core::entry::publish;
use bamboo_blake3_rs_core::entry::verify::batch::verify_batch_signatures;
use bamboo_blake3_rs_core::entry::verify::Error as VerifyError;
use bamboo_blake3_rs_core::entry::verify_batch;
use bamboo_blake3_rs_core::verify;
        ...
        b.iter(|| {
            entries
                ...
                .map(|(index, (entry, payload))| {
                    let seq_num = index + 1;
                    let lipmaa_num = bamboo_blake3_rs_core::lipmaa(seq_num as u64) - 1;
